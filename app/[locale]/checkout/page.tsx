      ...
      <div className="min-h-screen bg-white">
        ...
        <main className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-[100px] py-8 lg:py-12">
          <div className="flex flex-col items-center justify-center py-12 lg:py-20">
            <h2 className="text-[#3C4242] text-xl lg:text-2xl font-bold mb-4 text-center">{t('cartEmpty')}</h2>
            <p className="text-[#807D7E] text-base lg:text-lg mb-6 lg:mb-8 text-center">{t('addItemsBeforeCheckout')}</p>
            <button
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-[100px] py-6 lg:py-12">
        {/* Page Header */}
        <SectionHeader title={t('title')} className="mb-6 lg:mb-8" />
        ...
        <div className="flex items-center justify-center mb-8 lg:mb-12 overflow-x-auto pb-2">
          {steps.map((step, index) => (
            <div key={step.number} className="flex items-center flex-shrink-0">
              ...
              <span
                className={clsx(
                  'mx-2 lg:mx-3 text-xs lg:text-base font-medium',
          ...
          <div className="flex-1 space-y-6 lg:space-y-8 order-2 lg:order-1">
            ...
            {currentStep === 3 && (
              <div className="bg-white rounded-xl p-4 sm:p-6 lg:p-8 border border-[#BEBCBD]/30">
                <h2 className="text-[#3C4242] text-lg lg:text-2xl font-bold mb-4 lg:mb-6">{t('reviewOrder')}</h2>

                {shippingData && (
                  <div className="mb-4 lg:mb-6 pb-4 lg:pb-6 border-b border-[#BEBCBD]/30">
                    <h3 className="text-[#3C4242] font-medium mb-2 text-sm lg:text-base">{t('shippingAddress')}</h3>
                ...
                <div className="mb-4 lg:mb-6">
                  <h3 className="text-[#3C4242] font-medium mb-2 text-sm lg:text-base">{t('paymentMethod')}</h3>
                  <p className="text-[#807D7E] capitalize text-xs lg:text-sm">
                    {paymentMethod === 'card' ? t('creditCard') :
                      paymentMethod === 'paypal' ? t('paypal') : t('cashOnDelivery')}
                  </p>
                </div>
